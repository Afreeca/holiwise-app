export const DOCS_DATA = {
  title: "Web Application Document for Travel Agency",
  sections: [
    {
      ...
      subsections: [
        {
          ...
          content: `Current Issue: The drag and drop functionality does work well for desktop, but not work perfectly on mobile devices. there are many ways to implement it including using libraries like <a href="https://www.framer.com/motion/" className="text-blue-500 hover:underline">framer motion</a>`,
        },
        {
          content:
      ...
      subsections: [
        {
          ...
          content: `I did not follow and make sure the application meets standard accessibility guidelines <a className="text-blue-500 hover:underline" href="https://legacy.reactjs.org/docs/accessibility.html">React accessibility</a>.`,
        },
      ],
    },
    {
